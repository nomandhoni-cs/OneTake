# studio-controls Specification

## Purpose
In-camera controls for script selection and pause/resume lifecycle during recording. Owns the Studio top-bar script selector and pause/resume state machine that coordinates CaptureService, prompter scrolling, timer, Live Activity, and file segment merging.
