...
## Purpose
Profile tab as grouped inset preferences, Takes summary, and About information. Owns the Profile tab's inset list, per-tab NavigationStack independence, and placeholder rows for future account features.
